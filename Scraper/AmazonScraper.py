...
class AmazonScraper(Scraper):
    ...
    def Scrape(self):
        ...
        self._acceptCookies(self)
        self._changeCountryToDesiredCountry(self)
        self._changeCurrencyToDesiredCurrency(self)
        self._findProduct(self)
    ...
    def _getRelevantProductLinks(self):
        products= self.drive.find_elements(By.XPATH,"//div[contains(@class, 's-main-slot')]/div[@data-component-type='s-search-result']")
        ...
        for product in products:
            ...
            try:
                link = product.find_element(By.XPATH,".//a[@class='a-link-normal s-no-outline']").get_attribure("href")
            except:
    ...
    def _extractProductIdFromLink(link):
